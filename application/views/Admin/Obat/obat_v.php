...
font-size: 16px;"><a href="<?= site_url('admin/logout'); ?>" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">                 
                    <center><h2> Daftar Obat</h2></center>
                    <a href="<?php echo base_url().'admin/tambah_obat/'?>" class="btn btn-md btn-success"> Tambah Data </a>
                    <hr>
                    <div class="container">
                        ...
                        <div class="table-responsive">
                            <table id="table" class="table table-striped table-bordered table-hover" style="width: 89%;">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $hasil->tipe_obat ?></td>
                                    <td><?php echo $hasil->tingkat_gejala ?></td>
                                    <td><?php echo $hasil->stok ?></td>
                                    <td>
                                    <a href="<?php echo base_url().'admin/edit_obat/'?><?php echo $hasil->id_obat?>" class="btn btn-sm btn-success"> Edit </a>              
                                    <a href="<?php echo base_url().'admin/hapus_obat/'?><?php echo $hasil->id_obat?>" class="btn btn-sm btn-danger"> Hapus </a>
                                    </td>
                                </tr>
                                <?php } ?>
                                </tbody>                
