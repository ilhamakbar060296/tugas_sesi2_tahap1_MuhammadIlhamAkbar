                ...
                <div class="row">                 
                    ...
                    <div class="container">
                        <div class="col-mid-12">
                            <?php echo form_open('admin/simpan_obat');?>								
                            ...
                            <table id="table" class="table table-striped table-bordered table-hover" style="width: 89%;">
                                ...
                                <tbody>					
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="tipe" class="form_control" placeholder="Minum, Oles, Hirup">
                                        </td>
                                        </div>												
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="text" name="gejala" class="form_control" placeholder="Ringan, Sedang, Berat">
                                        </div>												
                                    </tr>
                                    <tr>
                                        <div class="form-group">
                                        <td><label for="text">Stok :</label></td>
                                        <td><input type="text" name="stok" class="form_control" placeholder="Banyak barang">
                                        </td>
                                        </div>												
                                    </tr>
                                    <tr>
