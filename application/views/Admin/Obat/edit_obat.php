...
font-size: 16px;"><a href="<?= site_url('admin/logout'); ?>" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">                 
                    <center><h2> Ubah Data Obat </h2></center>                    
                    <hr>
                    <div class="container">
                        <div class="col-mid-12">
                            <?php echo form_open('admin/update_obat');?>								
                            ...
                            <table id="table" class="table table-striped table-bordered table-hover" style="width: 89%;">
                                ...
                                <tbody>					
                                    <tr>
                                        ...
                                        <td><input type="hidden" value="<?php echo $get->id_obat ?>" name="id"></td>
                                        </td>
                                        </div>												
                                    </tr>
                                    <tr>
                                        <div class="form-group">
                                        <td><label for="text">Tipe Obat :</label></td>
                                        <td><input type="text" name="tipe" value="<?php echo $get->tipe_obat ?>" class="form_control" placeholder="Minum, Oles, Hirup">
                                        </td>
                                        </div>												
                                    </tr>
                                    <tr>
                                        <div class="form-group">
                                        <td><label for="text">Tingkat Gejala :</label></td>
                                        <td><input type="text" name="gejala" value="<?php echo $get->tingkat_gejala ?>" class="form_control" placeholder="Ringan, Sedang, Berat">
                                        </div>												
                                    </tr>
                                    <tr>
                                        <div class="form-group">
                                        <td><label for="text">Stok :</label></td>
                                        <td><input type="text" name="stok" value="<?php echo $get->stok ?>" class="form_control" placeholder="Banyak barang">
                                        </td>
                                        </div>												
                                    </tr>
                                    <tr>
