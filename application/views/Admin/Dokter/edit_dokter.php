...
font-size: 16px;"><a href="<?= site_url('admin/logout'); ?>" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">                 
                    <center><h2> Ubah Dokter </h2></center>                    
                    <hr>
                    <div class="container">
                        <div class="col-mid-12">
                            <?php echo form_open('admin/update_dokter');?>								
                            ...
                            <table id="table" class="table table-striped table-bordered table-hover" style="width: 89%;">
                                ...
                                <tbody>					
                                    <tr>
                                        ...
                                        <td><input type="text" name="nama" value="<?php echo $get->nama_dokter ?>"  class="form_control">
                                        <td><input type="hidden" value="<?php echo $get->id_dokter ?>" name="id"></td>
                                        </td>
                                        </div>												
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="text" name="usia" value="<?php echo $get->usia ?>" class="form_control">
                                        </td>
                                        </div>												
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="text" name="kelamin" value="<?php echo $get->jenis_kelamin?>" class="form_control">                                       
                                        </td>
                                        </div>												
                                    </tr>
                                    <tr>
                                        <div class="form-group">
                                        <td><label for="text">Spesialis / Ahli :</label></td>
                                        <td><input type="text" name="ahli" value="<?php echo $get->spesialis?>" class="form_control">
                                        </td>
                                        </div>												
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="text" name="alamat" value="<?php echo $get->alamat?>" class="form_control">
                                        </td>
                                        </div>												
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="text" name="telp" value="<?php echo $get->telp?>" class="form_control">
                                        </td>
                                        </div>												
                                    </tr>
                                    <tr>
