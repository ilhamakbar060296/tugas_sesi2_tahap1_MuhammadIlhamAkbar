...
font-size: 16px;"><a href="<?= site_url('admin/logout'); ?>" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">                 
                    <center><h2> Tambah Dokter </h2></center>                    
                    <hr>
                    <div class="container">
                        <div class="col-mid-12">
                            <?php echo form_open('admin/simpan_dokter');?>								
                            ...
                            <table id="table" class="table table-striped table-bordered table-hover" style="width: 89%;">
                                ...
                                <tbody>					
                                    ...
                                    <tr>
                                        <div class="form-group">
                                        <td><label for="text">Tanggal Lahir :</label></td>
                                        <td><input type="date" name="tanggal" class="form_control">
                                        </td>
                                        </div>												
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="ahli" class="form_control">
                                        </td>
                                        </div>												
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="text" name="alamat" class="form_control">
                                        </td>
                                        </div>												
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="text" name="telp" class="form_control">
                                        </td>
                                        </div>												
                                    </tr>
                                    <tr>
