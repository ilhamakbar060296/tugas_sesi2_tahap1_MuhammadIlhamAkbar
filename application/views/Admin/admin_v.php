...
font-size: 16px;"><a href="<?= site_url('admin/logout'); ?>" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <a href="<?= site_url('admin/dokter'); ?>"><div class="panel panel-back noti-box">
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">           
                <a href="chart.html"><div class="panel panel-back noti-box">
