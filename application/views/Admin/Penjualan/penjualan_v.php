...
font-size: 16px;"><a href="<?= site_url('admin/logout'); ?>" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">                 
                    <center><h2> Penjualan Obat</h2></center>
                    <a href="<?php echo base_url().'admin/tambah_penjualan/'?>" class="btn btn-md btn-success"> Tambah Nota Penjualan </a>
                    <hr>
                    <div class="container">
                        ...
                        <div class="table-responsive">
                            <table id="table" class="table table-striped table-bordered table-hover" style="width: 89%;">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $hasil->total_jual ?></td>
                                    <td><?php echo $hasil->tgl_jual ?></td>
                                    <td>
                                    <a href="<?php echo base_url().'admin/edit_penjualan/'?><?php echo $hasil->no?>" class="btn btn-sm btn-success"> Edit </a>              
                                    <a href="<?php echo base_url().'admin/hapus_penjualan/'?><?php echo $hasil->no?>" class="btn btn-sm btn-danger"> Hapus </a>
                                    </td>
                                </tr>
                                <?php 
                                    $total += $hasil->total_jual;
                                    } ?>
                                </tbody>                
                            </table>                                
                        </div>
                        <h3><strong><?php echo "Total Penjualan anda : Rp.".number_format($total , 0, ',', '.')?></strong></h3>
                    </div>
                <!--/row -->
                </div>
            <!--/page-inner -->
