...
font-size: 16px;"><a href="<?= site_url('admin/logout'); ?>" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">                 
                    <center><h2> Tambah Nota Penjualan </h2></center>                    
                    <hr>
                    <div class="container">
                        <div class="col-mid-12">
                            <?php echo form_open('admin/simpan_penjualan');?>								
                            ...
                            <table id="table" class="table table-striped table-bordered table-hover" style="width: 89%;">
                                ...
                                <tbody>					
                                    <tr>
                                        ...
                                        <td><input type="text" name="nama" class="form_control">
                                        </td>
                                        </div>												
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="text" name="obat" class="form_control">
                                        </td>
                                        </div>												
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="text" name="harga" id="harga" class="form_control" onchange="return autofill()">
                                        </td>
                                        </div>												
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="text" name="jumlah" id="jumlah" class="form_control" onchange="return autofill()">
                                        </div>												
                                    </tr>
                                    <tr>
                                        <div class="form-group">
                                        <td><label for="text">Total Jual :</label></td>
                                        <td><input type="text" name="total" id="total" class="form_control" onchange="return autofill()">
                                        </div>												
                                    </tr>
                                    <tr>
                                        <div class="form-group">
