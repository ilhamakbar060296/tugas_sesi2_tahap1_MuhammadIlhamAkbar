                ...
                <div class="row">                 
                    ...
                    <div class="container">
                        <div class="col-mid-12">
                            <?php echo form_open('admin/update_pembelian');?>								
                            ...
                            <table id="table" class="table table-striped table-bordered table-hover" style="width: 89%;">
                                ...
                                <tbody>					
                                    <tr>
                                        ...
                                        <td><input type="text" name="nama" value="<?php echo $get->nama_obat?>" class="form_control">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="harga" value="<?php echo $get->harga_beli?>" class="form_control">
                                        </td>
                                        </div>												
                                    </tr>
                                    <tr>
                                        <div class="form-group">
                                        <td><label for="text">Jumlah Beli :</label></td>
                                        <td><input type="text" name="jumlah" value="<?php echo $get->jumlah_beli?>" class="form_control">
                                        </div>												
                                    </tr>
                                    <tr>
                                        <div class="form-group">
                                        <td><label for="text">Total Beli :</label></td>
                                        <td><input type="text" name="total" value="<?php echo $get->total_beli?>" class="form_control">
                                        </div>												
                                    </tr>
                                    <tr>
                                        <div class="form-group">
                                        <td><label for="text">Tanggal Beli :</label></td>
                                        <td><input type="text" name="tanggal" value="<?php echo $get->tgl_beli ?> " class="form_control">
                                        </td>
                                        </div>												
                                    </tr>
                                    <tr>
