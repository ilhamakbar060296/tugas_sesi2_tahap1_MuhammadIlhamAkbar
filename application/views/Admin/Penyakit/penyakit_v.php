...
font-size: 16px;"><a href="<?= site_url('admin/logout'); ?>" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">                 
                    <center><h2> Data Penyakit </h2></center>
                    <a href="<?php echo base_url().'admin/tambah_penyakit/'?>" class="btn btn-md btn-success"> Tambah Data </a>
                    <hr>
                    <div class="container">
                        ...
                        <div class="table-responsive">
                            <table id="table" class="table table-striped table-bordered table-hover" style="width: 89%;">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $hasil->daerah_penyakit ?></td>
                                    <td><?php echo $hasil->gejala ?></td>                                    
                                    <td>
                                    <a href="<?php echo base_url().'admin/edit_penyakit/'?><?php echo $hasil->id_penyakit?>" class="btn btn-sm btn-success"> Edit </a>              
                                    <a href="<?php echo base_url().'admin/hapus_penyakit/'?><?php echo $hasil->id_penyakit?>" class="btn btn-sm btn-danger"> Hapus </a>
                                    </td>
                                </tr>
                                <?php } ?>
                                </tbody>                
