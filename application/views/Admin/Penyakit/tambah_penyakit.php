...
font-size: 16px;"><a href="<?= site_url('admin/logout'); ?>" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">                 
                    <center><h2> Tambah Data Penyakit </h2></center>                    
                    <hr>
                    <div class="container">
                        <div class="col-mid-12">
                            <?php echo form_open('admin/simpan_penyakit');?>								
                            ...
                            <table id="table" class="table table-striped table-bordered table-hover" style="width: 89%;">
                                ...
                                <tbody>					
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="tipe" class="form_control" placeholder="Kepala, Hidung, Telinga, Tenggorokan">
                                        </td>
                                        </div>												
                                    </tr>
                                    <tr>
