...
font-size: 16px;"><a href="<?= site_url('admin/logout'); ?>" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">                 
                    <center><h2> Daftar Pasien </h2></center>                    
                    <hr>
                    <div class="container">
                        ...
                        <div class="table-responsive">
                            <table id="table" class="table table-striped table-bordered table-hover" style="width: 89%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="<?php echo base_url().'admin/riwayat_pasien/'?><?php echo $hasil->id_pasien?>" class="btn btn-sm btn-success"> Riwayat berobat </a>
                                    </td>                                    
                                </tr>
                                <?php } ?>
                                </tbody>                
