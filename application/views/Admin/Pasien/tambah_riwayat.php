...
font-size: 16px;"><a href="<?= site_url('admin/logout'); ?>" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">                 
                    <center><h2> Tambah Riwayat </h2></center>                    
                    <hr>
                    <div class="container">
                        <div class="col-mid-12">
                            <?php echo form_open('admin/simpan_riwayat');?>								
                            <div class="container">
                        ...
                        <table id="table1" style="width: 20%;">
                            <thead>
                                <tr>
                                    ...
                                    <td><input type="hidden" value="<?php echo $get->nama_pasien ?>" name="pasien"></td>
                                    <td><input type="hidden" value="<?php echo $get->id_pasien ?>" name="id"></td>
                                </tr>
                                <tr>
                                    <th>Jenis Kelamin</th>
                                    <th>:</th>                                    
                            ...
                            <table id="table" class="table table-striped table-bordered table-hover" style="width: 87%;">
                                ...
                                <tr>
                                    ...
                                    <td><label for="text">Nama Dokter :</label></td>
                                    <div class="controls">
                                    <td><select name="dokter" class='form-control' id='dokter'>
                                    <option value='0'>--pilih--</option>
                                    <?php
                                    foreach ($dokter as $hasil1) {                                        
                                            echo "<option value='$hasil1->nama_dokter'>$hasil1->nama_dokter</option>";                                        	
                                    }							
                                    ?>
                                    </select></td>
                                    </div>
                                ...
                                <tr>
                                    ...
                                    <div class="controls">
                                    <td><select name="penyakit" class='form-control' id='penyakit'>
                                    <option value='0'>--pilih--</option>
                                    <?php
                                    foreach ($penyakit as $hasil2) {                                        
                                            echo "<option value='$hasil2->nama_penyakit'>$hasil2->nama_penyakit</option>";                                        	
                                    }							
                                    ?>
                                    </select></td>
                                    </div>
                                ...
                                <tr>
                                    <div class="form-group">
                                    <td><label for="text">Nama obat :</label></td>
                                    <div class="controls">
                                    <td><select name="obat" class='form-control' id='obat'>
                                    <option value='0'>--pilih--</option>
                                    <?php
                                    foreach ($obat as $hasil3) {                                        
                                            echo "<option value='$hasil3->nama_obat'>$hasil3->nama_obat</option>";                                        	
                                    }							
                                    ?>
                                    </select></td>
                                    </div>
                                    ...
                                    <tr>
                                        <div class="form-group">
                                        <td><label for="text">Jumlah :</label></td>
                                        <td><input type="text" name="jumlah" class="form_control">
                                        </td>
                                        </div>												
                                    </tr>
                                    <tr>
                                        <div class="form-group">
                                        <td><label for="text">Tanggal hari ini :</label></td>
                                        <td><input type="text" name="tanggal" value="<?php echo date("Y-m-d") ?>" class="form_control">
                                        </td>
                                        </div>												
                                    </tr>
                                    <tr>
